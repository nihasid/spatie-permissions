...
class CompanyCrudController extends CrudController
{
    ...
    {
        CRUD::column('id');
        CRUD::column('company_type_id');
        CRUD::column('company_name');
        CRUD::column('company_department');
        CRUD::column('short_description');
        CRUD::column('company_started_at');
        CRUD::column('company_ended_at');
        CRUD::column('status');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('company_department');
        CRUD::field('short_description');
        CRUD::field('company_started_at');
        CRUD::field('company_ended_at');
        CRUD::field('status');
